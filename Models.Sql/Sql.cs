...
namespace MyAirport.Pim.Models
{
    public class Sql : AbstractDefinition
    {
        ...
        private string commandGetBagageIata = "SELECT b.ID_BAGAGE, b.CODE_IATA, b.COMPAGNIE, b.LIGNE, b.DATE_CREATION, b.ESCALE, b.CLASSE," +
            "b EN_CONTINUATION, cast(iif(bp.PARTICULARITE is null, 0, 1) as bit) as 'RUSH', cast(iif(b.EN_CONTINUATION like 'N', 0, 1) as bit ) as 'CONT', " +
            "cast(iif(b.PRIORITAIRE like '0', 0, 1) as bit) as 'PRIO' " +
            "FROM BAGAGE b left outer join BAGAGE_A_POUR_PARTICULARITE bp on bp.ID_BAGAGE and (bp.ID_PARTICULARITE = 15) where b.code_iata = @code_iata";

        private string commandGetBagageId = "SELECT b.ID_BAGAGE, b.CODE_IATA, b.COMPAGNIE, b.LIGNE, b.DATE_CREATION, b.ESCALE, b.CLASSE," +
            "b EN_CONTINUATION, cast(iif(bp.PARTICULARITE is null, 0, 1) as bit) as 'RUSH', cast(iif(b.EN_CONTINUATION like 'N', 0, 1) as bit ) as 'CONT', " +
            "cast(iif(b.PRIORITAIRE like '0', 0, 1) as bit) as 'PRIO' " +
            "FROM BAGAGE b left outer join BAGAGE_A_POUR_PARTICULARITE bp on bp.ID_BAGAGE and (bp.ID_PARTICULARITE = 15) where b.ID_BAGAGE = @id";
